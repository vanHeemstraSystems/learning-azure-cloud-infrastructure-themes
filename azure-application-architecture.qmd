...
We base our Theme: Master Azure Application Architecture on Planning a [Minimum Viable Nothing (MVN)](https://github.com/vanHeemstraSystems/minimum-viable-nothing).

## 2. Find the **Opportunities**.

See [Learning - Azure Application Architecture](https://vanheemstrasystems.github.io/learning-azure-application-architecture/)
