...
We base our Theme: Master Azure Storage (relational) on Planning a [Minimum Viable Nothing (MVN)](https://github.com/vanHeemstraSystems/minimum-viable-nothing).

## 2. Find the **Opportunities**.

See [Learning - Azure Storage (relational)](https://vanheemstrasystems.github.io/learning-azure-storage-relational/)
