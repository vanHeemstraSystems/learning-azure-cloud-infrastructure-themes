...
We base our Theme: Master Azure Authentication and Authorization on Planning a [Minimum Viable Nothing (MVN)](https://github.com/vanHeemstraSystems/minimum-viable-nothing).

## 2. Find the **Opportunities**.

See [Learning - Azure Authentication and Authorization](https://vanheemstrasystems.github.io/learning-azure-authentication-and-authorization/)
